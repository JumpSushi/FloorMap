import { CustomLayerInterface, Map, Popup } from "maplibre-gl";
    ...
    map.addLayer({
      ...
      paint: {
        ...
        "fill-extrusion-height": [
          "case",
          ["has", "height"],
          ["*", ["get", "height"], 0.1], // Make corridors/levels much lower than rooms
          0.2
        ],
        "fill-extrusion-opacity": 1,
      },
